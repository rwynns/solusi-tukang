...
@section('content')
    <div class="py-32 bg-gray-100">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold font-poppins text-gray-900">Edit Profil</h1>
                <p class="mt-2 text-gray-600 font-roboto">Perbarui informasi profil dan alamat email akun Anda</p>
            </div>
                ...
                <div class="md:col-span-3">
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200">
                            <h2 class="text-xl font-semibold text-gray-900 font-poppins">Edit Data Diri</h2>
                        </div>
                        ...
                        <div class="p-6">
                            <form action="{{ route('profile.update') }}" method="POST">
                                ...
                                <div class="flex items-center justify-end">
                                    <button type="submit"
                                        class="px-6 py-2 bg-[#332E60] text-white rounded-md hover:bg-[#2A2655] transition-all font-poppins">
                                        Simpan Perubahan
                                    </button>
                                </div>
                            </form>
