    ...
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900 text-shadow-md">Edit Lokasi</h1>
                    ...
                    <form action="{{ route('locations.update', $location) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $location->name) }}"
                                ...
                                required>
                            <p class="mt-1 text-xs text-gray-500 font-roboto">Contoh: Tebet, Pancoran, Kebayoran Baru, dsb.
                            </p>
                        </div>
