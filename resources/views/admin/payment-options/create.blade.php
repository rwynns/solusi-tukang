...
@section('title', 'Tambah Payment Option')

@section('content')
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900 text-shadow-md">Tambah Payment Option</h1>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('payment-options.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1 flex items-center space-x-5">
                                    <span class="inline-block h-40 w-40 overflow-hidden bg-gray-100 rounded-lg"
                                        ...
                                        <img id="preview_logo" src="#" alt="Logo Preview"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1 flex items-center space-x-5">
                                    <span class="inline-block h-40 w-40 overflow-hidden bg-gray-100 rounded-lg"
                                        ...
                                        <img id="preview_qr" src="#" alt="QR Code Preview"
                                            class="h-full w-full object-contain hidden">
                                    </span>
