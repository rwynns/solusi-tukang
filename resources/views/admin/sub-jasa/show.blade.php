...
@section('title', 'Detail Sub Jasa')

@section('content')
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900 text-shadow-md">Detail Sub Jasa</h1>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900 font-poppins">Informasi Sub Jasa</h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500 font-roboto">Detail lengkap sub jasa yang ditawarkan.
                        </p>
                    </div>
                    <div class="flex space-x-3">
                        ...
                        <form action="{{ route('sub-jasa.destroy', $subJasa) }}" method="POST" class="inline delete-form">
                            @csrf
                            @method('DELETE')
                            <button type="button"
                            ...
                            <div class="md:col-span-2">
                                <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                    <div class="sm:col-span-2">
                                        <dt class="text-sm font-medium text-gray-500 font-poppins">Nama Sub Jasa</dt>
                                        <dd class="mt-1 text-lg font-semibold text-gray-900 font-roboto">
                                            {{ $subJasa->nama }}
                                        </dd>
                                    </div>

                                    <div class="sm:col-span-2">
                                        <dt class="text-sm font-medium text-gray-500 font-poppins">Jasa Utama</dt>
                                        <dd class="mt-1 text-sm">
                                            <a href="{{ route('kelola-jasa.show', $subJasa->jasa) }}"
                                                class="inline-flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-blue-100 text-blue-800 hover:bg-blue-200">
                                    ...
                                    <div class="sm:col-span-2">
                                        <dt class="text-sm font-medium text-gray-500 font-poppins">Harga</dt>
                                        <dd class="mt-1 text-lg font-semibold text-gray-900 font-mono">
                                    ...
                                    <div class="sm:col-span-2 border-t border-gray-200 pt-4">
                                        ...
                                        <dd class="mt-2 text-gray-900 font-roboto space-y-3">
                                            @if ($subJasa->deskripsi)
                                                {!! nl2br(e($subJasa->deskripsi)) !!}
                                            @else
