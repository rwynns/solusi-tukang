    ...
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900 text-shadow-md">Tambah Sub Jasa</h1>
                <a href="{{ route('sub-jasa.index', request()->has('jasa_id') ? ['jasa_id' => request('jasa_id')] : []) }}"
        ...
        <div class="max-w-5xl mx-auto">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('sub-jasa.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                ...
                                <select name="jasa_id" id="jasa_id"
                                    ...
                                    @foreach ($jasaList as $jasa)
                                        <option value="{{ $jasa->id }}"
                                            {{ old('jasa_id') == $jasa->id || (isset($selectedJasa) && $selectedJasa->id == $jasa->id) ? 'selected' : '' }}>
                                            {{ $jasa->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 font-roboto">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <p class="mt-2 text-xs text-gray-500 font-roboto">Format: JPG, PNG. Maks: 2MB. Gambar tidak
                                    wajib diisi.</p>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            imageInput.addEventListener('change', function(event) {
                ...
                if (file) {
                    ...
                    // Cek ukuran file (max 3MB = 3 * 1024 * 1024 bytes)
