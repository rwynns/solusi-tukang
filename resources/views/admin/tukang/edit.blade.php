    ...
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900 text-shadow-md">Edit Tukang</h1>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('tukang.update', $tukang) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                            <div class="col-span-1">
                                <label for="name" class="block mb-1 text-sm font-medium font-poppins">Nama
                                    Lengkap</label>
                                <input type="text" name="name" id="name" value="{{ old('name', $tukang->name) }}"
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="password" name="password" id="password"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 font-roboto">
                                <p class="mt-1 text-xs text-gray-500 font-roboto">Kosongkan jika tidak ingin mengubah
                                    password</p>
                            </div>
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="text" name="phone_number" id="phone_number"
                                    value="{{ old('phone_number', $tukang->phone_number) }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 font-roboto"
                                    required>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="address" id="address" rows="2"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 font-roboto"
                                    required>{{ old('address', $tukang->address) }}</textarea>
                            </div>
                                ...
                                <select name="location_id" id="location_id"
                                    ...
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}"
                                            {{ old('location_id', $tukang->tukangProfile->location_id) == $location->id ? 'selected' : '' }}>
                                            {{ $location->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="border border-gray-300 rounded-lg p-3 bg-white">
                                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                        @php
                                            $selectedSkills = old(
                                                'skills',
                                                $tukang->tukangProfile->skills->pluck('id')->toArray(),
                                            );
                                        @endphp
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="bio" id="bio" rows="4"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-500 font-roboto">{{ old('bio', $tukang->tukangProfile->bio) }}</textarea>
                                    ...
                                    <span class="inline-block h-24 w-24 rounded-full overflow-hidden bg-gray-100"
                                        ...
                                        @else
                                            <svg class="h-full w-full text-gray-300" fill="currentColor"
                                                viewBox="0 0 24 24" id="default_avatar">
                                                <path
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            photoInput.addEventListener('change', function(event) {
                ...
                if (file) {
                    ...
                    // Jika tidak ada file, kembalikan ke gambar current jika ada, atau avatar default
