...
@section('content')
    ...
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900">Kelola Keahlian</h1>
    ...
    <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-gray-50">
        <div class="bg-white px-4 py-3 shadow rounded-lg mb-6">
            <form action="{{ route('skills.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-center">
                <div class="flex-1">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        @foreach ($skills as $index => $skill)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-roboto">
                                    {{ $index + $skills->firstItem() }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-roboto">{{ $skill->name }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-roboto">{{ $skill->created_at->format('d M Y') }}</div>
                                </td>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada data keahlian</h3>
                    <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan keahlian baru.</p>
                    <div class="mt-6">
                        <a href="{{ route('skills.create') }}"
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: `Anda akan menghapus keahlian "${skillName}"`,
                        icon: 'warning',
