    ...
    <div class="bg-white shadow">
        <div class="px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold font-poppins text-gray-900 text-shadow-md">Edit Jasa</h1>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('kelola-jasa.update', $jasa) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama', $jasa->nama) }}"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <p class="mt-1 text-xs text-gray-500 font-roboto">Slug akan diperbarui otomatis dari nama
                                    jasa
                                </p>
                            </div>
